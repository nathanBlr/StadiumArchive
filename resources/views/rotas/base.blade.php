...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    <div>
      ...
      <form class="max-w-md mx-auto pt-3" action="{{ route('search') }}" method="GET">   
...
<footer class="bg-white rounded-lg shadow fixed left-0 right-0 bottom-0 dark:bg-gray-900 m-4">
